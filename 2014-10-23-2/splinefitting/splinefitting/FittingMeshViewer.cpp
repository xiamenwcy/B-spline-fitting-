...
//void FittingMeshViewer::draw_density_mesh()
//{
//	if(surfacedata==NULL)
//		return;
...
//void FittingMeshViewer::draw_control_mesh()
//{
//#if 0
...
//}
//
//void FittingMeshViewer::draw_adjusted_control_mesh()
//{
...
//void FittingMeshViewer::draw_curvature_mesh()
//{
//	if(surfacedata==NULL)
//		return;
//	Polyhedron *m_pOriginalMesh = surfacedata->get_original_mesh();
//	
//	if(m_pOriginalMesh != NULL && m_pOriginalMesh->is_valid() && !m_pOriginalMesh->empty())
//	{
//		m_pOriginalMesh->gl_draw(true, true);
//	}
//}
//
//void FittingMeshViewer::draw_sparsemesh()
//{
//	if(!surfacedata)
//		return;
//
...
//}
//
//void FittingMeshViewer::draw_sparsecurves()
//{
//	if(!surfacedata)
//		return;
//
...
//}
//
//void FittingMeshViewer::draw_adjusted_mesh()
//{
...
//void FittingMeshViewer::set_curvature_show(bool cv)
//{
//	bcurvature_show = cv;
//	Polyhedron *m_pOriginalMesh = surfacedata->get_original_mesh();
//
...
//}
//
//void FittingMeshViewer::set_density_show(bool dv)
//{
//	if(dv)
//	{
...
//	updateGL();
//}
//void FittingMeshViewer::set_controlmesh_show(bool cm)
//{
//	basis_size = surfacedata->get_basis_size();
//	if(cm)
//	{
...
//
//
//void FittingMeshViewer::draw_density_colorbar(QPainter *painter) 
//{
...
//}
//
//void FittingMeshViewer::draw_curvature_colorbar(QPainter *painter) 
//{
//	const int barwidth = 20;
//	const int barheight = 200;
//	painter->save();
...
void FittingMeshViewer::set_controledge_show(bool cv)
{
	...
	if(cv)
	{
		if(surfacedata==NULL||!surfacedata->mesh_fitting())
			return;
		CBSplineSurfaceView* bsurface=surfacedata->getbspline();
        ControlPoint=bsurface->getControlPoint();
		if (ControlPoint.empty())
