...
static const char qt_meta_stringdata_MeshSubWindow[] = {
    "MeshSubWindow\0\0current_file_changed()\0"
    "window_close()\0surfacedata\0"
...
void MeshSubWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->current_file_changed(); break;
        case 1: _t->window_close(); break;
        case 2: _t->surfacedata_changed((*reinterpret_cast< CSurfaceData*(*)>(_a[1]))); break;
        case 3: _t->set_origin_mesh_view((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->set_curvature_show((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->set_adjustpoints_enabled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->set_adjusted_enabled((*reinterpret_cast< bool(*)>(_a[1]))); break;
...
// SIGNAL 0
void MeshSubWindow::current_file_changed()
{
