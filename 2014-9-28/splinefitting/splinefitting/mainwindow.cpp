...
mainwindow::mainwindow(void)
{
	...
	connect(this,SIGNAL(updateMeshWindow(CSurfaceData *)),meshwindow,SLOT(start_update_meshwindow(CSurfaceData *)));
...
void mainwindow::open()
{
	...
	if(!fileName.isEmpty())
	{
      ...
      /*****  update meshwindow and send surfacedata        ************/
		emit  updateMeshWindow(surfacedata);
		/*****      after updating ,begin painting            ****/
