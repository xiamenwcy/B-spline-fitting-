...
void MeshSubWindow::start_update_meshwindow(CSurfaceData *surfacedata)
 {
   set_surface_data(surfacedata);
 }
...
void MeshSubWindow::set_surface_data(CSurfaceData *data)
{
	surfacedata = data;
	updateStatusBar();
	m_pMeshViewer->update_view(data);
}
...
//void MeshSubWindow::mesh_fitting()
//{
//	surfacedata->mesh_fitting();
//}
//
