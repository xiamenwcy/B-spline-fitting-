...
void KnotSubWindow::createActions()
{
	...
	//connect(domainmeshAction, SIGNAL(toggled(bool)), this, SLOT(domain_mesh_view(bool)));
	errdomainAction = new QAction(tr("Error Domain"), this);
	...
	segmentAction = new QAction(tr("Error Triangles"), this);
	segmentAction->setCheckable(true);
	//connect(segmentAction,	SIGNAL(toggled(bool)), this, SLOT(show_error_triangles(bool)));
...
//}
//
//void KnotSubWindow::domain_mesh_view(bool dv)
//{
