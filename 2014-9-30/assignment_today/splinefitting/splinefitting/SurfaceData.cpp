...
bool CSurfaceData::read_mesh(const QString &name)
{
	...
	if(extension == ".off")
	{
		if(!OpenMesh::IO::read_mesh(*m_pOriginalMesh, fileName.toStdString()))
		{
	...
	m_pOriginalMesh->update_face_normals();
	m_pOriginalMesh->request_vertex_normals();
	m_pOriginalMesh->update_vertex_normals();
...
//		typedef	CGAL::Mean_value_coordinates_parameterizer_3<Parameterization_polyhedron_adaptor, Border_parameterizer>
//																	Parameterizer;
//		if(m_pOriginalMesh->is_valid() && !m_pOriginalMesh->empty())
//		{
//			Polyhedron mesh = *m_pOriginalMesh;
...
//			int i = 0;
//			sample_num = mesh.size_of_vertices();
//			if(domain == NULL)
//			{
//				domain = new Point_2[sample_num];
//			}
...
//}
//
//Point_2 *CSurfaceData::get_domain()
//{
//	return domain;
//}
//
...
//}
//
//vector<Knot_Data> &CSurfaceData::get_knots()
//{
//	return cdt_knotstri.get_knots();
//}
//
