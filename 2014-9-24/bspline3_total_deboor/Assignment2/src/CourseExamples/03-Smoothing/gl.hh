...
inline void glVertex(const OpenMesh::Vec2f& _v)  { glVertex2fv(_v); }
/// Wrapper: glVertex for OpenMesh::Vec2d
inline void glVertex(const OpenMesh::Vec2d& _v)  { glVertex2dv(_v); }
...
inline void glVertex(const OpenMesh::Vec4f& _v)  { glVertex4fv(_v); }
/// Wrapper: glVertex for OpenMesh::Vec4d
inline void glVertex(const OpenMesh::Vec4d& _v)  { glVertex4dv(_v); }
...
inline void glTexCoord(const OpenMesh::Vec2f& _t) { glTexCoord2fv(_t); }
/// Wrapper: glTexCoord for OpenMesh::Vec2d
inline void glTexCoord(const OpenMesh::Vec2d& _t) { glTexCoord2dv(_t); }

/// Wrapper: glTexCoord for OpenMesh::Vec3f
inline void glTexCoord(const OpenMesh::Vec3f& _t) { glTexCoord3fv(_t); }
/// Wrapper: glTexCoord for OpenMesh::Vec3d
inline void glTexCoord(const OpenMesh::Vec3d& _t) { glTexCoord3dv(_t); }

/// Wrapper: glTexCoord for OpenMesh::Vec4f
inline void glTexCoord(const OpenMesh::Vec4f& _t) { glTexCoord4fv(_t); }
/// Wrapper: glTexCoord for OpenMesh::Vec4d
inline void glTexCoord(const OpenMesh::Vec4d& _t) { glTexCoord4dv(_t); }
...
inline void glColor(const OpenMesh::Vec3f&  _v)  { glColor3fv(_v); }
/// Wrapper: glColor for OpenMesh::Vec3uc
inline void glColor(const OpenMesh::Vec3uc& _v)  { glColor3ubv(_v); }

/// Wrapper: glColor for OpenMesh::Vec4f
inline void glColor(const OpenMesh::Vec4f&  _v)  { glColor4fv(_v); }
/// Wrapper: glColor for OpenMesh::Vec4uc
inline void glColor(const OpenMesh::Vec4uc&  _v) { glColor4ubv(_v); }
